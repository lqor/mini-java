...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    new Statement[] {new Return(new Call("ggt", new Expression[] { new Number(3780), new Number(3528)}, false))});
//    new Statement[] {new Return(new Call("ggt", new Expression[] { new Number(378000), new Number(3528)}))});
    ...
    Statement fakRec = new Return(new Binary(new Variable("n"), Binop.MultiplicationOperator,
        new Call("fak", new Expression[] {new Binary(new Variable("n"), Binop.Minus, new Number(1))}, false)));
